...
params_txt <- paste('NEH_Init "NEH_Init" c (neh)',
  ...
  'NEH_Init_NEH_First_Priority "NEH_Init_NEH_First_Priority" c (sum_pij,dev_pij,avgdev_pij,abs_dif,ss_sra,ss_srs,ss_srn_rcn,ss_sra_rcn,ss_srs_rcn,ss_sra_2rcn,ra_c1,ra_c2,ra_c3,lr_it_ct,lr_it,lr_aj,lr_ct) | NEH_Init_NEH_Ratio %in% c("0.25","0.5","0.75","1")',
  ...
  'NEH_Init_NEH_Priority "NEH_Init_NEH_Priority" c (sum_pij,dev_pij,avgdev_pij,abs_dif,ss_sra,ss_srs,ss_srn_rcn,ss_sra_rcn,ss_srs_rcn,ss_sra_2rcn,ra_c1,ra_c2,ra_c3,lr_it_ct,lr_it,lr_aj,lr_ct) | NEH_Init_NEH_Ratio %in% c("0","0.25","0.5","0.75")',
  ...
  'NEH_Init_NEH_Insertion "NEH_Init_NEH_Insertion" c (first_best,last_best) | NEH_Init_NEH_Ratio %in% c("0","0.25","0.5","0.75")',
  sep = '\n')
