...
int main(int argc, const char* argv[]){
  IloEnv env;
  try {
    const char* filename = "/home/lucasmp/projects/git/evolutionary_solvers"
                           "/data/instances/generated_intances/generated_instances_all/"
                           "binom_10_5_1005101.gen";
