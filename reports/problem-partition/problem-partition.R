...
experiments <- tribble(
  ...
  "flowshop-corr-50j10m-arquive", "MOEA/D+irace", list(
    strategy = "moead",
    # parameters
    algorithm = algorithm,
    # problems
  ...
  "flowshop-corr-50j10m-irace-extremes", "irace-extremes", list(
  ...
  "flowshop-objective-50j10m-100ils-arquive", "MOEA/D+irace", list(
    strategy = "moead",
    # parameters
    algorithm = algorithm,
    # problems
  ...
  "flowshop-objective-50j10m-ga-100ils-arquive", "MOEA/D", list(
    strategy = "moead",
    # parameters
    algorithm = algorithm,
    # problems
  ...
  # ),
  # "flowshop-type-50j10m-irace100", "MOEA/D+irace-na", list(
  #   strategy = "moead",
  #   # parameters
  #   algorithm = algorithm,
  #   # problems
  ...
  #   irace_variation_no_samples = 4
  # ),
  "flowshop-type-50j10m-irace100-arquive", "MOEA/D+irace", list(
    strategy = "moead",
    # parameters
    algorithm = algorithm,
    # problems
