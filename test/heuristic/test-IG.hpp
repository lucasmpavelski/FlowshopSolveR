...
params["IG.AOS.TS.Strategy"] = "dynamic" ;
params["IG.AOS.TS.C"] = "91" ;
prob["dist"] = "uniform" ;
prob["corr"] = "job-correlated" ;
prob["no_jobs"] = "20" ;
prob["no_machines"] = "10" ;
...
prob["id"] = "1213" ;
prob["set_type"] = "train" ;
prob["instance"] = "uniform_job-correlated_20_10_01.txt" ;
RNG::seed(557698556);
;
  RunOptions ro;;
