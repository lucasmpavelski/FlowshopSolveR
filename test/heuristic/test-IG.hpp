...
params["IG.AdaptivePerturb.AOS.WarmUp"] = "1000" ;
params["IG.AdaptivePerturb.AOS.WarmUp.Strategy"] = "random" ;
params["IG.AdaptivePerturb.AOS.RewardType"] = "3" ;
params["IG.AdaptivePerturb.AOS.Strategy"] = "thompson_sampling" ;
params["IG.AdaptivePerturb.AOS.TS.Strategy"] = "static" ;
params["IG.AdaptivePerturb.AOS.TS.C"] = "NA" ;
