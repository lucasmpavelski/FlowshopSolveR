...
TEST(Solve, IG) {
  ...
  // params["IG.Init.LocalSearch"               ] = "none";
  ...
  // params["IG.LS.Single.Step"                 ] = "0"; // c (0, 1)
  ...
  // params["IG.LSPS.Single.Step"               ] = "0"; // c (0,1) | IG.Perturb == 'lsps' & IG.LSPS.Local.Search != 'none'
  ...
  // params["IG.AOS.WarmUp"          ] = "100"; // r (0.0,0.5) | IG.Perturb.DestructionSizeStrategy == 'adaptive'
  ...
  // params["IG.AdaptivePosition.AOS.Options"] = "0_1_2_3";
  ...
  // params["IG.AdaptivePosition.AOS.RewardType"] = "1" ;
...
prob["budget"] = "med" ;
prob["id"] = "395" ;
prob["instance"] = "uniform_random_300_60_07.txt" ;
params["IG.Init"] = "neh";
...
params["IG.Init.LocalSearch"] = "none";
params["IG.Init.LocalSearch.SingleStep"] = "0" ;
...
params["IG.Perturb.DestructionSize"] = "2" ;
params["IG.Perturb.Insertion"] = "random_best" ;
params["IG.DestructionStrategy"] = "adaptive_position" ;
params["IG.AdaptivePosition.AOS.WarmUp.Strategy"] = "random" ;
params["IG.AdaptivePosition.AOS.Options"] = "0_1_2_3" ;
params["IG.AdaptivePosition.AOS.WarmUp"] = "1000" ;
params["IG.AdaptivePosition.AOS.RewardType"] = "1" ;
params["IG.AdaptivePosition.AOS.Strategy"] = "probability_matching" ;
params["IG.AdaptivePosition.AOS.PM.RewardType"] = "extabs" ;
params["IG.AdaptivePosition.AOS.PM.Alpha"] = "0.2958" ;
params["IG.AdaptivePosition.AOS.PM.PMin"] = "0.1083" ;
params["IG.AdaptivePosition.AOS.PM.UpdateWindow"] = "96" ;
*/
params["IG.Init"] = "neh" ;
params["IG.Init.NEH.Ratio"] = "0" ;
params["IG.Init.NEH.Priority"] = "sum_pij" ;
...
params["IG.AdaptivePosition.AOS.WarmUp.Strategy"] = "random" ;
params["IG.AdaptivePosition.AOS.Options"] = "0_1_2_3" ;
params["IG.AdaptivePosition.AOS.WarmUp"] = "1593" ;
params["IG.AdaptivePosition.AOS.RewardType"] = "1" ;
